...
namespace hds
{
	...
	public class MarginEncryption
	{
		...
		public byte[] decryptMargin(byte[] packet)
        {
			...
			au.copy (packetToDecrypt,0,packet,17,packet.Length-17);
			...
			au.copy(decryptedPacket,0,decryptedBytes,10,decryptedBytes.Length-10);
